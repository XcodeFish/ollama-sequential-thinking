...
set VSIX_FILE=ollama-sequential-thinking-1.3.0.vsix
...
if %errorlevel% == 0 (
    ...
    echo 🗑️  卸载旧版本插件...
    code --uninstall-extension codefish.ollama-sequential-thinking >nul 2>&1
...
if %errorlevel% == 0 (
    ...
    echo 🗑️  卸载旧版本插件...
    cursor --uninstall-extension codefish.ollama-sequential-thinking >nul 2>&1
...
echo    - Ctrl+Shift+A: 提问
echo    - Ctrl+Shift+G: 生成代码
